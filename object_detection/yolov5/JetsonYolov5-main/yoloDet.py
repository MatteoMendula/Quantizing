...
class YoloTRT():
    ...
    def Inference(self, img):
        ...
        unprocess_results = {}
        unprocess_results["boxes"] = result_boxes
        unprocess_results["scores"] = result_scores
        unprocess_results["labels"] = result_classid
        ...
        return det_res, unprocess_results, t2-t1 
    ...
    def PlotBbox(self, x, img, color=[255,0,0], label=None, line_thickness=1):
